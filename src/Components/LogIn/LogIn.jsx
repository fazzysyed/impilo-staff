...
export default function LogIn() {
  ...
  const firebaseToken = useSelector((state) => state.firebaseToken);
  ...
  const loginHandler = async () => {
    if (email.length && !emailError && password.length) {
      ...
      const config = {
        method: "post",
        url: "https://brightspace.health/api/staff-login",
      ...
      axios(config)
        .then((response) => {
          ...
          if (response?.data?.data?.user) {
            ...
            let newUser = response.data?.data?.user;
    ...
    <>
      <div className="flex flex-col w-full h-screen  overflow-auto items-center ">
        ...
        <div className="flex w-full h-full justify-center flex-col md:flex-row ">
          <div className="bg-[#524494]  flex items-center justify-center w-full">
            <img
              src={Slide2}
              ...
              {/* <div className="flex justify-between flex-col md:flex-row gap-3 w-full pt-4">
                ...
                <div>
                  <div
                    ...
                    className="text-base/none cursor-pointer pb-2 whitespace-nowrap font-normal text-neutral-600"
                  >
